...
### Objective
Test case checks whether OpenSwitch OVS is able to drive the Internal ASIC OVS and set the configurations correctly in both the OVS'. Ports in Access Mode gets configured only when corresponding VLAN is added. If the VLAN gets deleted, respective ports with matching tags gets deleted from the internal OVS. Following test cases will verify ping traffic in different configurations.
### Requirements
...
### Objective
Test case checks whether OpenSwitch OVS is able to drive the Internal ASIC OVS and set the configurations correctly in both the OVS'. Ports in Trunk Mode gets configured only when corresponding VLAN is added. If the VLAN gets deleted, respective ports with matching trunks gets deleted from the internal OVS. Following test cases will verify ping traffic in different configurations.
### Requirements
- Virtual Mininet Test Setup
...
### Objective
Test case checks whether OpenSwitch OVS is able to drive the Internal ASIC OVS and set the configurations correctly in both the OVS'. Bonds in Access Mode gets configured only when corresponding VLAN is added. If the VLAN gets deleted, respective bonds with matching tags gets deleted from the internal OVS.
...
### Objective
Test case checks whether OpenSwitch OVS is able to drive the Internal ASIC OVS and set the configurations correctly in both the OVS'. Bonds in Trunk Mode gets configured only when corresponding VLAN is added. If the VLAN gets deleted, respective bonds with matching trunks gets deleted from the internal OVS.
