...
ACLs can be created and entries added to and removed from the ACLs.  The ACLs
can be applied to and removed from interfaces within container.  The ACLs will
not filter traffic within the container.
